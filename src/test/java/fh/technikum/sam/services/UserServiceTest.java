...
public class UserServiceTest {
    ...
    void getAllRegularTest() {
        ...
        assertThat(userService.getAll()).isEqualTo(List.of(registeredUser1, registeredUser2));
    }
    ...
    void registerTestRegular() {
        User registeredUser = userService.register(userDto1);
        assertThat(userService.userExists(registeredUser)).isTrue();
    }

    @Test
    void registerTestFail() {
        User registeredUser1 = userService.register(userDto1);
        assertThat(userService.userExists(registeredUser1)).isTrue();
